...
{
    public class CONTATOCadastroVW : ViewModelBase
    {
        ...
        public string CAMPO3
        {
            get
            {
                return tipoCliente switch
                {
                    TipoCliente.FISICA => "NOME SOCIAL: ",
                    TipoCliente.JURIDICA => "NOME FANTASIA: ",
                    _ => "ERRO"
                };
            }
        }
       ...
       // public List<REFERENCIA> REFERENCIAs { get; set; }
        ...
        public CONTATOCadastroVW()
        {
            ...
            //REFERENCIAs = _context.REFERENCIAs.Select(c => c).Where(c => c.CONTATO == CONTATO).ToList();
        }
        ...
        public void ObtemDadosViaCEP(string cep)
        {
            ...
            try
            {
                ...
                CONTATO.DDD_CELULAR1 = infoCEP.ddd;
                CONTATO.DDD_CELULAR2 = infoCEP.ddd;
